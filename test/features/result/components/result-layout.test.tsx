...
describe("ResultLayout - 4-Section Structure", () => {
  describe("SECTION 1: HEADER COM RESUMO", () => {
  ...
  describe("SECTION 2: ESTATÍSTICAS", () => {
    ...
    test("linha de domínio com desempenho excelente (>= 70%)", () => {
      ...
      const domainRow = screen.getByLabelText(
        "Desempenho de Conceitos de Nuvem"
      )
  ...
  describe("SECTION 3: REVISÃO DE QUESTÕES", () => {
  ...
  describe("SECTION 4: BOTÃO VOLTAR", () => {
  ...
  describe("Integração de 4 Seções", () => {
